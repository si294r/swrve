...
$url_kpi_json = "https://dashboard.swrve.com/api/1/exporter/kpi/avg_session_length.json";
...
$data_url = "start=$start&stop=$stop&granularity=$granularity&transpose=$transpose&only_data=$only_data";
  ...
  <head>
    ...
    <script type="text/javascript">
      ...
      function drawChart_ios() {
        ...
        var options = {
          title: 'Average Session Length IOS',
          curveType: 'function',
          legend: { position: 'bottom' }
        };
