 ...
 */
include "/var/www/swrve_jellypop_ios_key.php";
...
if (!is_object($json)) {
    ...
    exec("s3cmd --recursive del s3://user-db/jellypop_ios");
}
    ...
    foreach ($object as $value) {
        if (is_object($value) || is_array($value)) {
            ...
            if (strpos($value, "https://") !== FALSE) {
                ...
                exec("s3cmd put {$GLOBALS['dir']}/$filename s3://user-db/jellypop_ios/$filename");
            }
        }
    }
}
