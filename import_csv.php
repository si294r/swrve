...
//load data local infile './userdbs-2016-04-13/all-users_02618_2016-04-13_abtest_exposure.1_0.1.csv' into table swrve.abtest_exposure fields terminated by ',' enclosed by '\"' lines terminated by '\n' ignore 1 rows
...
//    $cmd = "load data local infile '$filename' "
