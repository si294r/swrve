...
$url_kpi_json = "https://dashboard.swrve.com/api/1/exporter/kpi/mau.json";
$history = 60;
...
$content = exec("curl -G -k \"$url_kpi_json?api_key=$api_key&personal_key=$personal_key&history=$history\"");
...
$content_ios = exec("curl -G -k \"$url_kpi_json?api_key=$api_key&personal_key=$personal_key&history=$history\"");
